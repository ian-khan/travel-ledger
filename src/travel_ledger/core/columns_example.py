...
COLUMNS: list[Column] = [
    ...
    Column("Date", "TEXT NOT NULL", "YYYY-mm-dd or YYmmdd", 10,
           validate_format=validate_date_format, as_groups=True),
    ...
    Column("Payer", "TEXT", "", 5,
           choices=("Person A", "Person B")),
    Column("Method", "TEXT", "", 6,
           choices=("Cash", "Card"), as_groups=True),
    Column("Category", "TEXT", "", 9,
           choices=("Hotel", "Transport", "Meal", "Shopping", "Donation", "Admission"),
           as_groups=True),
    Column("Items", "TEXT", "", 36,
           is_counted_items=True),
    Column("Note", "TEXT", "", 4),
]